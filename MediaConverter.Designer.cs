namespace Media_Player_SMP
{
    partial class MediaConverter
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.saveFileDialog1.Title = "メディアファイルを保存";
            // 
            // groupBox1
            // 
            ...
            this.groupBox2.Size = new System.Drawing.Size(321, 47);
            this.groupBox2.TabIndex = 3;
            this.groupBox2.TabStop = false;
            this.groupBox2.Text = "ファイルの保存先";
            // 
            // button2
            // 
            ...
            this.groupBox3.Size = new System.Drawing.Size(321, 53);
            this.groupBox3.TabIndex = 5;
            this.groupBox3.TabStop = false;
            this.groupBox3.Text = "変換先のファイル形式";
            // 
            // comboBox1
            // 
            ...
            "-----選択してください-----",
            "Audio Code number 3 (.ac3 .avi .vob .m2ts .mp4)",
            "Audio Interchange File Format (.aiff .aif .aifc)",
            "A-lawアルゴリズム (.alaw)",
            "Advanced Systems Format (.asf .wma .wmv)",
            "AST (Nintendo Wiiで使用) (.ast)",
            "Sunオーディオファイル (.au)",
            "Audio Video Interleave (.avi)",
            "Core Audio Format (.caf)",
            "Raw DTS (.dts)",
            "Raw E-AC-3 (.eac3)",
            "FFserver live feed (.ffm)",
            "Free Lossless Audio Codec (.flac)",
            "Flash Video (.flv .f4v .f4p .f4a .f4b)",
            "Raw H.261 (.h261)",
            "Raw H.263 (.h263)",
            "ITU-T Rec. H.264 / ISO/IEC 14496-10 Advanced Video Coding (.h264)",
            "Raw MPEG-4 Part 14 (.m4v)",
            "Matroska (.matroska)",
            "Raw Motion JPEG (.mjpeg)",
            "PCM mu-law (.mulaw)",
            "Ogg (.ogv .oga .ogx .ogg .spx)",
            "OpenMG Audio (.oma)",
            "WebM (.webm)",
            "Windows Media Video (.wmv .avi)",
            "RAWビデオデータ",
            "RAWデータ"});
